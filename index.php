  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        ...
        <p><strong>Tushar Chopra</strong></p>
        <p>CGC 4th year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
	  ...
	  <p><span class="glyphicon glyphicon-map-marker"></span> Tushar Chopra</p>
      <p><span class="glyphicon glyphicon-map-marker"></span> DELHI, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 8586813165 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> 1802973.cse.cec@cgc.edu.in@gmail.com</p>
    </div>
